...
{
    public partial class add_rasp_form : Form
    {
        string connect, query;
        DataSet ds;
        DataTable dt;
        SqlDataAdapter adapterSql;
        public add_rasp_form(Form1 main_form)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                query = "insert into Расписание([ID расписание],[ID Преподаватель_кафедра],[№ аудитории],Время,[группа-предмет]) values('" + textBox1.Text + "','"+comboBox1.Text+"','" + comboBox2.Text + "','" + comboBox3.Text + "','" + comboBox4.Text + "');";
                adapterSql = new SqlDataAdapter(query, connect);
                adapterSql.Fill(ds);
                dt.Dispose();
                ds.Dispose();
        ...
        private void add_rasp_form_Load(object sender, EventArgs e)
        {
            dt = new DataTable();
            ds = new DataSet();
